...
<html>
    ...
    <body>
        <div class="topnav">
            ...
            <a class="active" href="select_pr10.php">Visualize (pr10)</a>
       ...
       # echo "***" .$temp;
        ...
        $sql = "SELECT name, origin FROM crossreactivity_pr10";
        #echo $sql;
        ...
        $query = "SELECT * FROM crossreactivity_pr10 WHERE name = '".$temp."'";
        #echo "<br>";
        #echo $query;
        #echo"<br>";
